...
if not os.path.isfile('model_new.keras'):
    subprocess.run(['curl --output model_new.keras "https://raw.githubusercontent.com/rashmika-fdo/Stock-Price-Prediction-WebApp/18632af440a3c2a6a6eef84624869f0af724782f/Model5.keras"'], shell=True)
